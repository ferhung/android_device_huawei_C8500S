...
#
#      http://www.apache.org/licenses/LICENSC8500SE-2.0
#
...
# Extract prebuilt libraries (from a CM7 running device) needed for the C8500S
...
adb pull /system/etc/AudioFilterC8500S.csv ../../../vendor/huawei/$DEVICE/proprietary/etc/AudioFilterC8500S.csv
...
adb pull /system/lib/hw/gps.C8500S.so ../../../vendor/huawei/$DEVICE/proprietary/lib/hw/gps.C8500S.so
...
chmod 755 ../../../vendor/huawei/C8500S/proprietary/bin/* 
...
# All the blobs necessary for C8500S
PRODUCT_COPY_FILES += \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/huawei/__DEVICE__/proprietary/etc/AudioFilterC8500S.csv:system/etc/AudioFilterC8500S.csv \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/huawei/__DEVICE__/proprietary/lib/hw/gps.C8500S.so:system/lib/hw/gps.C8500S.so \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/huawei/__DEVICE__/proprietary/lib/libqcamera.so:obj/lib/libqcamera.so \\
    ...
    vendor/huawei/__DEVICE__/proprietary/lib/libril-qc-1.so:obj/lib/libril-qc-1.so \\
